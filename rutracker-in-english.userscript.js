...
(function() {
    ...
    const replacementPhrases = { // Phrases
        ...
        'Бесстыжие / Shameless': 'Shameless',
        'Черное зеркало / Black Mirror': 'Black Mirror',
        'Теория Большого Взрыва / The Big Bang Theory': 'The Big Bang Theory',
        ...
        'Доктор Хаус / House M.D.': 'House M.D.',
        'Викинги / Vikings': 'Vikings',
        'Карточный домик': 'House of Cards',
        'Сериалы совместного производства нескольких стран': 'Series co-produced by several countries',
        'VMV и др. ролики': 'VMV & other videos',
        'Сериалы Латинской Америки с озвучкой': 'Latin American TV series with voice acting',
        'Сериалы Латинской Америки с субтитрами': 'Latin American TV series with subtitles',
        'Сериалы Колумбии': 'Colombian TV series',
        'Сериалы Венесуэлы': 'Venezuelan TV series',
        'Сериалы Аргентины': 'Argentina TV series',
        'Сериалы Бразилии': 'Brazilian TV series',
        'Сериалы Индии': 'Indian TV series',
        'Сериалы Мексики': 'Mexican TV series',
        'Китайские сериалы': 'Chinese TV series',
        'Японские сериалы': 'Japanese TV series',
        'Сериалы совместного производства': 'Co-produced series',
        'Сериалы Турции': 'Turkish TV series',
        'Сериалы Таиланда, Индонезии, Сингапура': 'TV series from Thailand, Indonesia, Singapore',
        'Корейские сериалы': 'Korean TV series',
        'раздачи папками': 'folder distribution',
        'Веб-сериалы, Вебизоды к сериалам и Пилотные серии сериалов': 'Web Series, Webisodes for TV Series & Pilots for TV Series',
        'Для некондиционных': 'For substandard',
        ...
        'Сериалы стран Африки, Ближнего и Среднего Востока': 'Series from Africa, Middle East & Near East',
        'Европейские сериалы': 'European TV series',
        'Итальянские сериалы': 'Italian TV Series',
        'Испанские сериалы': 'Spanish TV series',
        'Скандинавские сериалы': 'Scandinavian TV series',
        'Сериалы Великобритании и Ирландии': 'UK & Ireland TV series',
        'Обсуждение сериалов': 'Discussion of TV series',
        'Психология преступления': 'Psychology of crime',
        'Некрасивая подружка': 'Ugly girlfriend',
        'Женская версия': 'Female version',
        'Универ / Универ. Новая общага / СашаТаня': 'University / University. New Dorm / SashaTanya',
        'Я знаю твои секреты': 'I know your secrets',
        'Московские тайны': 'Moscow secrets',
        'По законам военного времени': 'According to the laws of wartime',
        'Сельский детектив': 'Country detective',
        'Личное сообщ.:': 'Personal message:',
        'Выйти на всех устройствах': 'Logout on all devices',
    ...
    const replacementWords = { // Single words
        ...
        'Статистика отключена:': 'Statistics are disabled:',
