...
(function() {
    ...
    const replacementPhrases = { // Phrases
        ...
        'Лог проверки': 'Verification log',
        'с встроенным': 'with built-in',
        'Влажно-сухая': 'Wet-dry',
        'Не было': 'There was no',
        'Динамический отчет': 'Dynamic report',
        'Условия оцифровки': 'Digitization conditions',
        'Скрипка соло': 'Violin solo',
        'Исполнительский состав': 'Cast',
        'Соло мандолины': 'Mandolin Solo',
        'Соло мандолина': 'Mandolin Solo',
        'Техническая информация': 'Technical information',
        'Код класса состояния': 'Condition Class Code',
        'собственное приобретение': 'own purchase',
        'только обложка': 'cover only',
        'Производитель диска': 'Disc manufacturer',
        'Все микрофонные буферные усилители и предусилители изготовлены компанией': 'All microphone buffer amplifiers & preamplifiers are manufactured by the company',
        'сведено с помощью': 'brought together with',
        'Аналогово-цифровой конвертер': 'Analog to digital converter',
        'Продюсер записи': 'Recording producer',
        'баланс-инженер': 'balance engineer',
        'Лог DR': 'DR Log',
        'Дата записи': 'Date of recording',
        'Битрейт аудио': 'Audio bitrate',
        'Замер динамического диапазона': 'Dynamic Range Measurement',
        'Год издания релиза': 'Year of release',
        'WEB релиз': 'Web release',
        'Номер по каталогу': 'Catalogue number',
        'Год переиздания': 'Year of reissue',
        ...
        'ОС и программы семейства UNIX': 'UNIX OS & programs',
        'ОС и серверные программы Microsoft': 'Microsoft OS & Server Programs',
        'Компьютерные сети и безопасность': 'Computer Networks & Security',
        'Ударные стили': 'Percussion styles',
        ...
        'Айкидо и айки-дзюцу': 'Aikido & aiki-jutsu',
        'Психотерапия и клиническая психология': 'Psychotherapy & clinical psychology',
        'Медицина и стоматология': 'Medicine & Dentistry',
        'Хобби и рукоделие': 'Hobbies & handicrafts',
        'Растения и животные': 'Plants & animals',
        'Дерево- и металлообработка': 'Wood & metalworking',
        'Строительство, ремонт и дизайн': 'Construction, renovation & design',
        'Пикап, знакомства': 'Pickup, dating',
        'Эзотерика, саморазвитие': 'Esoterics, self-development',
        'Учебные видео для детей': 'Educational videos for kids',
        'Беременность, роды, материнство': 'Pregnancy, childbirth, motherhood',
        'Продажи, бизнес': 'Sales, business',
        'Фокусы и трюки': 'Tricks & tricks',
        'Рыболовство и подводная охота': 'Fishing & spearfishing',
        'Танцы, разное': 'Dancing, miscellaneous',
        'Уличные и клубные танцы': 'Street & club dancing',
        'Танец живота': 'Belly dance',
        'Бальные танцы': 'Ballroom dancing',
        'Игра на бас-гитаре': 'Playing bass guitar',
        'Другие музыкальные инструменты': 'Other musical instruments',
        ...
        'Тематические коллекции книг': 'Thematic book collections',
        'Ветеринария, разное': 'Veterinary medicine, miscellaneous',
        'Популярная медицинская периодика': 'Popular medical periodicals',
        'Фармация и фармакология': 'Pharmacy & pharmacology',
        'Научная медицинская периодика': 'Scientific medical periodicals',
        'Клиническая медицина с': 'Clinical medicine from',
        ...
        'Интерактивные обучающие и развивающие материалы': 'Interactive educational & developmental materials',
        'Мультимедийные энциклопедии': 'Multimedia encyclopedias',
        'Многопредметные коллекции': 'Multi-subject collections',
        'Тематические коллекции': 'Thematic collections',
        'зеркала сетевых библиотек/коллекций': 'mirrors of online libraries/collections',
        ...
        'книги о ПК': 'books about PC',
        'Хакинг и безопасность': 'Hacking & Security',
        'Сети / VoIP': 'Networks / VoIP',
        'Графика, обработка': 'Graphics, processing',
        'Программы от Microsoft': 'Programs from Microsoft',
        'Самиздат и книги, изданные за счет авторов': "Samizdat & books published at the authors' expense",
        'Литературные журналы': 'Literary magazines',
        'Женский роман': "Women's novel",
        'Детектив, боевик': 'Detective, action movie',
        'Прочие хобби и игры': 'Other hobbies & games',
        'Ремонт, частное строительство, дизайн интерьеров': 'Repair, private construction, interior design',
        'Приусадебное хозяйство / Цветоводство': 'Homestead / Floriculture',
        ...
        'Коллекционирование и вспомогательные ист. дисциплины': 'Collecting & auxiliary historical disciplines',
        'Сексология. Взаимоотношения полов': 'Sexology. Gender relations',
        ...
        'Нетрадиционные религиозные, духовные и мистические учения': 'Non-traditional religious, spiritual & mystical teachings',
        'Спецслужбы мира': 'Intelligence agencies of the world',
        'Учебно-методическая литература': 'Educational & methodological literature',
        'Стрелковое оружие': 'Small arms',
        'Биографии и мемуары военных деятелей': 'Biographies & memoirs of military figures',
        'Самоучители и Школы': 'Self-study Guides & Schools',
        'Другие направления': 'Other directions',
        'Ноты, табулатуры': 'Sheet music, tablatures',
        'Ноты и Media CD': 'Sheet Music & Media CD',
        'Академическая музыка': 'Academic music',
        'Военная история': 'Military history',
        'Журналы: научные, научно-популярные, радио и др': 'Magazines: scientific, popular science, radio, etc',
        'Нормативная документация': 'Regulatory documentation',
        ...
        'Металлургия / Материаловедение': 'Metallurgy / Materials Science',
        'Автоматизация / Робототехника': 'Automation / Robotics',
        'Сварка / Пайка / Неразрушающий контроль': 'Welding / Soldering / Non-destructive testing',
        'Архитектура / Строительство / Инженерные сети / Ландшафтный дизайн': 'Architecture / Construction / Engineering networks / Landscape design',
        'Схемы и сервис-мануалы': 'Schematics and service manuals',
        'оригинальная документация': 'original documentation',
        ...
        'История стран бывшего СССР': 'History of the former USSR countries',
        'История Америки, Австралии, Океании': 'History of America, Australia, Oceania',
        'Международные отношения. Дипломатия': 'International relations. Diplomacy',
        'Этнография, антропология': 'Ethnography, anthropology',
        'История Европы': 'History of Europe',
        'История Нового и Новейшего времени': 'History of Modern & Contemporary Times',
        'Древний мир. Античность': 'Ancient World. Antiquity',
        'Альтернативные исторические теории': 'Alternative historical theories',
        'Исторические источники': 'Historical sources',
        'Методология и философия исторической науки': 'Methodology & philosophy of historical science',
        'Юридические науки. Право. Криминалистика': 'Legal sciences. Law. Forensic science',
        'Бизнес, менеджмент': 'Business, management',
        'Публицистика, журналистика': 'Publicism, journalism',
        ...
        'Игровые виды спорта': 'Game sports',
        'Худ. лит-ра для средних и старших классов': 'Fiction for middle & high school',
        'Худ. лит-ра для дошкольников и младших классов': 'Fiction for preschoolers & primary school children',
        'Воспитание и развитие': 'Education & development',
        'Досуг и творчество': 'Leisure & creativity',
        'Научно-популярная и познавательная литература': 'Popular science & educational literature',
        ...
        'Фото и видеосъемка': 'Photo & video shooting',
        'Рисунок, графический дизайн': 'Drawing, graphic design',
        'Школьные учебники, ЕГЭ, ОГЭ': 'School textbooks, Unified State Exam, Basic State Exam',
        'Восточные языки': 'Eastern languages',
        'иностранные языки': 'foreign languages',
        'на других иностранных языках': 'in other foreign languages',
        'LIM-курсы': 'LIM courses',
        'Мультиязычные сборники и курсы': 'Multilingual collections & courses',
        'Русский язык как иностранный': 'Russian as a foreign language',
        'Другие восточные языки': 'Other Eastern languages',
        'на восточных языках': 'in eastern languages',
        'Немецкий язык': 'German',
        'на немецком языке': 'in German',
        'на французском языке': 'in French',
        'Французский язык': 'French',
        'Испанский язык': 'Spanish',
        'Итальянский язык': 'Italian',
        'Финский язык': 'Finnish',
        'Другие европейские языки': 'Other European Languages',
        'на других европейских языках': 'in other European languages',
        'Арабский язык': 'Arabic',
        'Китайский язык': 'Chinese',
        'Японский язык': 'Japanese',
        'Аудио и видео ролики': 'Audio & video clips',
        'Юмористические аудиопередачи': 'Humorous audio programs',
        'Сатирики и юмористы': 'Satirists & humorists',
        'Школа злословия': 'School of Slander',
        'Танцевальные шоу, концерты, выступления': 'Dance shows, concerts, performances',
        'Украинские Шоу': 'Ukrainian Shows',
        'Фильмы со смешным переводом': 'Movies with funny translation',
        'Вечерний Квартал': 'Evening Quarter',
        'Хорошие Шутки': 'Good Jokes',
        'Званый ужин': 'Dinner Party',
        'Музыкальные шоу': 'Musical shows',
        'Ледовые шоу': 'Ice shows',
        'Кривое Зеркало / Городок / В Городке': 'Crooked Mirror / Gorodok / In Gorodok',
        'Пост КВН': 'KVN post',
        'Детские телешоу': "Children's TV shows",
        'Реалити и ток-шоу / номинации / показы': 'Reality & talk shows / nominations / shows',
        'Интеллектуальные игры и викторины': 'Intellectual games & quizzes',
        'Приколы и юмор': 'Jokes & humor',
        'Ищу / предлагаю': 'Looking for / offering',
        'Некондиционное видео - Документальные': 'Substandard video - Documentaries',
        'Информационно-аналитические и общественно-политические': 'Informational, analytical and socio-political',
        'Разное / некондиция': 'Miscellaneous / substandard',
        'Альтернативная история и наука': 'Alternative history & science',
        'Паранормальные явления': 'Paranormal phenomena',
        'Русские сенсации / Программа Максимум / Профессия репортёр': 'Russian sensations / Maximum program / Profession reporter',
        'Битва экстрасенсов / Теория невероятности / Искатели / Галилео': 'Battle of Psychics / Theory of Improbability / Seekers / Galileo',
        'Новое и Новейшее время': 'New & Modern Times',
        ...
        'Научно-популярные фильмы': 'Popular Science Films',
        'Аварии / Катастрофы / Катаклизмы': 'Accidents / Catastrophes / Disasters',
        'Вторая мировая война': 'World War II',
        'Тайны века / Спецслужбы / Теории Заговоров': 'Secrets of the Century / Intelligence Services / Conspiracy Theories',
        'Криминальная документалистика': 'Crime Documentary',
        'Искусство, история искусств': 'Art, art history',
        'Мастера искусств Театра и Кино': 'Masters of Arts of Theatre & Cinema',
        'Кинематограф и мультипликация': 'Cinematography & animation',
        "Правила, инструкции, FAQ'и": 'Rules, instructions, FAQs',
        'Восточной Азии': 'East Asia',
        'Культы и новые религиозные движения': 'Cults & New Religious Movements',
        ...
        'можно отредактировать или удалить': 'can be edited or deleted',
        'находятся отправленные, но еще не прочитанные получателем сообщения. В': 'there are messages sent but not yet read by the recipient.',
        'они попадают только после того, как получатель их прочтет. Сообщения, находящиеся в папке': 'They only arrive after the recipient has read them. Messages in the folder',
        'Отметить / Переключить': 'Mark / Toggle',
        'Удалить отмеченное': 'Remove marked',
        'Срок хранения ЛС': 'PM shelf life',
        'Пользователь не найден': 'User not found',
        'Такого форума не существует': 'Such a forum does not exist',
    ...
    const replacementWords = { // Single words
        ...
        'Солисты': 'Soloists',
        'смонтировано': 'edited',
        'Звукорежиcсер': 'Sound engineer',
        'Звукоинженер': 'Sound producer',
        'Монтаж': 'Installation',
        'Записано': 'Recorded',
        'Запись': 'Recording',
        'записи': 'records',
